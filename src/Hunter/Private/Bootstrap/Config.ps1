...
$script:RollbackRoot       = Join-Path $script:HunterRoot 'Rollback'
$script:RollbackManifestPath = Join-Path $script:RollbackRoot 'rollback-manifest.json'
$script:RollbackScriptPath = Join-Path $script:RollbackRoot 'Restore-HunterState.ps1'
$script:RunConfigurationPath = Join-Path $script:HunterRoot 'run-configuration.json'
...
$script:StorageMediaContext = $null
$script:PowerPlatformContext = $null
...
$script:SelectedProfile = 'Aggressive'
...
$script:DisableCpuMitigationsRequested = $false
$script:DisableHagsRequested = $false
$script:HagsPreferenceResolved = $false
$script:HagsDisableResolvedValue = $false
$script:ForceStorageOptimizationRequested = $false
$script:DisableAudioEnhancementsRequested = $false
$script:DisableSystemSoundsRequested = $false
$script:ForceTextInputServiceRedirectRequested = $false
$script:RunTcpOptimizerRequested = $false
$script:RunOOSURequested = $false
$script:PagefileDriveOverride = $null
...
$script:HunterContext.Flags = @{
    ...
    RunTcpOptimizerRequested    = $script:RunTcpOptimizerRequested
    RunOOSURequested            = $script:RunOOSURequested
