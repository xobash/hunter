function Get-HunterPrivateAssetManifest {
    return @(
        ...
        [pscustomobject]@{ RelativePath = 'src\Hunter\Private\Tasks\Catalog.ps1'; Sha256 = '5447d606a5b0ac60dbc8a3ad3f62b0cef1d5236034c0a540a6f0a97d6cbdd494'; Order = 540; Kind = 'Script' }
