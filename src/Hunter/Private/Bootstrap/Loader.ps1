function Get-HunterPrivateAssetManifest {
    return @(
        ...
        [pscustomobject]@{ RelativePath = 'src\Hunter\Private\Apps\AppCatalog.ps1'; Sha256 = '202f51cfc917151fecf80a7e27c28a607b03721da205fc0aad363a07682c48f2'; Order = 190; Kind = 'Script' }
