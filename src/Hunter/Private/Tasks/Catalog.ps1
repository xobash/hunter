...
function Get-HunterTaskCatalog {
    $catalog = @(
        ...
        [pscustomobject]@{ Id = 'tweaks-input-maintenance'; Phase = '7'; Handler = { Invoke-ApplyInputAndMaintenanceTweaks }; Description = 'Disable mouse acceleration, suppress the text input service, tune timer policy, and disable scheduled maintenance tasks' }
